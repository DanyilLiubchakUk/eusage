...
tauri_panel! {
    ...
    panel_event!(UsageBoardPanelEventHandler {
...
pub fn init(app_handle: &tauri::AppHandle) -> tauri::Result<()> {
    ...
    let panel = window.to_panel::<UsageBoardPanel>()?;
    ...
    let event_handler = UsageBoardPanelEventHandler::new();
