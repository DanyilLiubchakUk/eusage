(function () {
  ...
  var GOOGLE_CLIENT_ID_ENV = "ANTIGRAVITY_GOOGLE_CLIENT_ID"
  var GOOGLE_CLIENT_SECRET_ENV = "ANTIGRAVITY_GOOGLE_CLIENT_SECRET"
  ...
  function refreshAccessToken(ctx, refreshTokenValue) {
    ...
    var clientId = readEnvText(ctx, GOOGLE_CLIENT_ID_ENV)
    var clientSecret = readEnvText(ctx, GOOGLE_CLIENT_SECRET_ENV)
    if (!clientId || !clientSecret) {
      ctx.host.log.warn("refresh skipped: set ANTIGRAVITY_GOOGLE_CLIENT_ID and ANTIGRAVITY_GOOGLE_CLIENT_SECRET")
      return null
    }
