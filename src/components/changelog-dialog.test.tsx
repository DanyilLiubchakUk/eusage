...
describe("ChangelogDialog", () => {
  ...
  it("renders current release with markdown content and GitHub link", async () => {
    ...
    changelogState.releases = [
      {
        ...
        html_url: "https://github.com/DanyilLiubchakUk/eusage/releases/tag/v1.2.3",
      },
    ]
    ...
    expect(openerState.openUrlMock).toHaveBeenCalledWith(
      "https://github.com/DanyilLiubchakUk/eusage/releases/tag/v1.2.3",
    )
    ...
    expect(openerState.openUrlMock).toHaveBeenCalledWith(
      "https://github.com/DanyilLiubchakUk/eusage/pull/123",
    )
    ...
    expect(openerState.openUrlMock).toHaveBeenCalledWith(
      "https://github.com/DanyilLiubchakUk/eusage/commit/abcdef1",
    )
    ...
    changelogState.releases = [
      {
        ...
        body: "body",
        published_at: null,
        html_url: "https://github.com/DanyilLiubchakUk/eusage/releases/tag/v1.0.1",
      },
    ]
  ...
  it("shows link to full changelog when multiple releases exist", async () => {
    changelogState.releases = [
      ...
      },
      {
        ...
        html_url: "https://github.com/DanyilLiubchakUk/eusage/releases/tag/v0.9.0",
      },
    ]
    ...
    expect(openerState.openUrlMock).toHaveBeenCalledWith(
      "https://github.com/DanyilLiubchakUk/eusage/releases",
    )
  })
    ...
    changelogState.releases = [
      {
        ...
        html_url: "https://github.com/DanyilLiubchakUk/eusage/releases/tag/v0.1.0",
      },
    ]
