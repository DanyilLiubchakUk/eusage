...
Use this when eUsage is not working and you need to share debug info.
...
If eUsage does not open at all, skip this step and continue.
...
1. Attach `eusage.log`.
2. If you also see files like `eusage.log.1`, attach those too.
